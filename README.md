...
We can use [SemVer](http://semver.org/) for versioning, [read more](../production/versioning.md)
...
If there's an API automated generated docs, link to API documentation. If not describe your API including authentication methods as well as explaining all the endpoints with their required parameters.
